...
// Generate random honks spread over the last 14 days
const generateSeedData = () => {
  const records = [];
  const now = new Date();

  for (let day = 0; day < 14; day++) {
    // Random honk count per day: between 40 and 200
    ...
    for (let i = 0; i < honksToday; i++) {
      ...
      // Weight hours toward rush hours (8–10am, 5–8pm)
      ...
      records.push({ city: "Ahmedabad", timestamp });
    }
  }
